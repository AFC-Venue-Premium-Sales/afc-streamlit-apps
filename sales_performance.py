...
def run_app():
    ...
    with st.expander("📖 How to Use This App - Sales Performance"):
        ...
        **Step-by-Step Guide:**
        ...
        3. **Analyse Trends**:
           - Use the **daily sales table** for a breakdown of transactions.
           - View the **sales trend line** for daily revenue trends over time.
           - Explore the **heatmap** to identify peak sales hours on specific dates.
        4. **Visualize Revenue**:
           - The **bar chart** highlights revenue generated by each fixture.
        5. **Refresh Data**:
        ...
        **Helpful Tips:**
        ...
        - Hover over graphs and charts for detailed tooltips.
