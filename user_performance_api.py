...
#             total_package_sales_by_exec['TotalPrice'] = total_package_sales_by_exec['TotalPrice'].apply(lambda x: f"£{x:,.2f}")
...
#             avg_sale_value_per_exec['TotalPrice'] = avg_sale_value_per_exec['TotalPrice'].apply(lambda x: f"£{x:,.2f}")
...
#             total_discounts_given_by_exec['DiscountValue'] = total_discounts_given_by_exec['DiscountValue'].apply(lambda x: f"£{x:,.2f}")
...
#             st.download_button(
#                 label="💾 Download Filtered Data for In-depth Analysis",
#                 data=output,
